...
<body class="home-page">
    ...
    <button class="assistant-launcher" id="assistantLauncher" type="button" aria-label="Open PeraHP Assist" aria-expanded="false">
        <span aria-hidden="true"><img src="logo.png" alt=""></span><strong>Ask PeraHP</strong>
    </button>
    <aside class="assistant-window" id="assistantWindow" aria-label="PeraHP Assist" aria-hidden="true">
        <header><div><span class="assistant-avatar"><img src="logo.png" alt=""></span><div><strong>PeraHP Assist <em>AI</em></strong><small><i></i> Online · Ready to help</small></div></div><button type="button" id="assistantClose" aria-label="Close assistant">×</button></header>
